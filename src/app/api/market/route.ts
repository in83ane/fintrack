...
import { marketCache, generateCacheKey, queryDeduplicator } from '@/src/lib/cache';
...
export async function GET(request: Request) {
  ...
  const cacheKey = generateCacheKey('market', { symbols: symbols.sort().join(',') });
  ...
  try {
    // Use deduplicator to prevent duplicate parallel requests
    ...
    marketCache.set(cacheKey, responseData);
